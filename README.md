...
<img width="1280" height="720" alt="QQ20250902-214831" src="https://github.com/user-attachments/assets/39de2f38-6288-4461-a9f8-0ca3a609dbce" />
   ...
   # -嘛, 就是这个样子了, 最主要的经验值获取来源是每几秒检测一次当前使用的应用, 判断是否属于学习系统(re白名单), 总共88级, 80级后所需要的经验值会更多, 是两套公式, 类似于突破, 还有键盘输入, 文件保存都有经验值, 不过一切都还是雏形, 升级动画也因为bug注释掉了-  <br>
...
<img width="1280" height="720" alt="QQ20250902-215403" src="https://github.com/user-attachments/assets/3bb07483-1653-4678-be14-d856c80fda92" />
   ...
   # -具体思路如下:(使用的程序是obsidian, 一个很好用的"笔记本")-  <br>
   
<img width="1280" height="720" alt="image" src="https://github.com/user-attachments/assets/78974cb5-d616-42d5-9ac9-a9d24a6393f2" />

   # -后续想的是加入一个本地ai模型用于基于用户的学习目标编写并发布学习任务(类似这个)<br>
   
<img width="1730" height="974" alt="QQ20250903-123009" src="https://github.com/user-attachments/assets/99d0675f-5256-44ba-b73f-70e8b5fc8221" />

   # -可以获得经验和其他的物品(金币什么的), 在考虑是否要加入经济系统, 但它是否违背了学习的初衷?只有经验值的话反馈的力度是否足够呢?有太多太多问题了-<br>
